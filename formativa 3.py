puestos = ["ceo","desarollador", "analista de datos"]
empleados = []
...
def imprimir_planilla(empleados):
    ...
    with open (archivo_planilla, "w") as archivo:
        for i in empleados:
            archivo.write(f"nombre y apellido: {i ['nombre']}\n")
            archivo.write(f"cargo: {i['cargo']}\n")
            archivo.write(f"sueldo bruto: {i['sueldo bruto']}\n")
            archivo.write(f"descuento salud:{i['descuento salud']}\n")
            archivo.write(f"descuento afp:{i['descuento afp']}\n")
            archivo.write(f"liquido a pagar:{i['liquido pagar']}\n")
